  ...
  return (
    <div className="min-h-dvh bg-admin-bg px-4 py-8 text-white">
      <div className="mx-auto max-w-lg">
        ...
        <h1 className="mb-8 text-2xl font-bold">Crear Folio</h1>

        <div className="rounded-xl border border-admin-border bg-admin-surface p-6">
          <form action={formAction} className="space-y-5">
            {/* Sucursal */}
            <div>
              <Label htmlFor="sucursal_id" required className="text-gray-300">
                Sucursal
              </Label>
              <Select
                id="sucursal_id"
            ...
            {/* Cliente */}
            <div>
              <Label htmlFor="cliente_id" required className="text-gray-300">
                Cliente
              </Label>
              <Select
                id="cliente_id"
