  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex items-center justify-between">
        <h2 className="text-base font-bold text-tech-text-primary">Equipos</h2>
      ...
      {!isCompleted && (
        <div className="rounded-card border border-tech-border bg-tech-surface p-4 space-y-3">
          <p className="text-body font-medium text-tech-text-secondary">Agregar equipo</p>
          ...
          <button
            ...
            className="flex w-full items-center justify-center gap-2 rounded-lg border border-dashed border-gray-300 px-3 py-2.5 text-sm font-medium text-tech-text-secondary transition-colors active:bg-gray-50"
          >
            <svg
      ...
      {entries.length === 0 ? (
        <div className="rounded-card border border-tech-border bg-tech-surface p-6 text-center">
